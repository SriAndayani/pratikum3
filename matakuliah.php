...
<header>
    <div class="container">
        <img src="logo/instiki.png" width="200px">
        <ul>
        ...
        <table border="1" cellspacing="0" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center"><a href="edit-matakuliah.php?id=<?php echo $row['matakuliah_id'] ?>">Edit</a> || <a href="hapus.php?idk=<?php echo $row['matakuliah_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a></td>
                </tr>
                <?php }}else{ ?>
                    <tr>
